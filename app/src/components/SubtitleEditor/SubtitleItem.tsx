  ...
  return (
    <Card
      className={cn(
        ...
        'transition-all duration-200 [transition-timing-function:cubic-bezier(0.25,0.1,0.25,1)]',
        isSelected
          ? 'bg-gradient-to-br from-primary/15 via-primary/10 to-primary/5 glow-primary ring-1 ring-primary/40 border-primary/30'
    ...
    >
      ...
      <div
        className={cn(
          ...
          'transition-all duration-200 [transition-timing-function:cubic-bezier(0.25,0.1,0.25,1)]',
          isSelected ? 'bg-primary glow-primary' : 'bg-transparent'
        )}
      />
