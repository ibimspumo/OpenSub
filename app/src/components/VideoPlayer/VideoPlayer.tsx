    ...
    >
      ...
      >
        ...
        <video
          ...
          src={mediaSrc(project.videoPath)}
          className="w-full h-full object-contain transition-transform duration-500 [transition-timing-function:cubic-bezier(0.25,0.1,0.25,1)]"
        ...
        <div
          className={`
            ...
            pointer-events-none
            transition-opacity duration-300 [transition-timing-function:cubic-bezier(0.25,0.1,0.25,1)]
          ...
          >
            ...
            <div
              className={`
                ...
                ${isHoveringProgress || isDraggingProgress ? 'glow-primary' : ''}
              `}
            ...
            <div
              className={`
                ...
                bg-white shadow-md
                transition-all duration-150 [transition-timing-function:cubic-bezier(0.34,1.56,0.64,1)]
      ...
      >
        ...
        <button
          ...
          className="p-2 rounded-lg text-muted-foreground hover:text-white hover:bg-white/[0.06] transition-all duration-150 [transition-timing-function:cubic-bezier(0.34,1.56,0.64,1)] hover:scale-105 active:scale-95"
        ...
        {/* Time Display */}
        <div className="hidden sm:flex items-center gap-1 text-xs text-muted-foreground font-mono tabular-nums">
          <span className="text-foreground/80">{formatTime(controller.currentTime)}</span>
        ...
        >
          ...
          <div
            className={`
              overflow-hidden transition-all duration-200 [transition-timing-function:cubic-bezier(0.34,1.56,0.64,1)]
              ${isHoveringVolume ? 'w-20 opacity-100' : 'w-0 opacity-0'}
            `}
          >
            <div className="relative h-1 w-20 bg-muted rounded-full group/vol">
              <div
