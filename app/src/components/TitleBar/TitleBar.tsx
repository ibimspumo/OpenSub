          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={cn(
                  'w-5 h-5 rounded-md bg-gradient-to-br from-primary to-primary/70',
                  'flex items-center justify-center ',
                  'no-drag transition-all duration-150',
                  hasProject() && 'hover:scale-110 glow-primary cursor-pointer'
                )}
                disabled={!hasProject()}
              >
                <Subtitles className="w-3 h-3 text-primary-foreground" />
              </button>
            </TooltipTrigger>
            {hasProject() && (
