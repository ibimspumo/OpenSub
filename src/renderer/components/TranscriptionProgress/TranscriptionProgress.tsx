...
const STAGE_CONFIG = {
  ...
  diarizing: {
    label: 'Erkenne Sprecher...',
    description: 'Verschiedene Stimmen werden identifiziert',
...
function StageIndicator({ currentStage }: { currentStage: Progress['stage'] }) {
  const stages: Progress['stage'][] = ['loading', 'transcribing', 'aligning', 'diarizing', 'complete']
